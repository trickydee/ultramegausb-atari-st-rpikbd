#!/bin/bash
################################################################################
# Build Script for Atari ST USB Adapter - Wireless Build
# Builds firmware for:
...
echo "================================================================================"
echo "  Atari ST USB Adapter - Wireless Build"
...
echo ""
echo "  ℹ️  NOTE: Bluetooth support is available on Pico 2 W (RP2350) only."
...
echo ""
echo "Note: Bluetooth support is available on Pico 2 W (RP2350) only."
echo "      Pico W (RP2040) does not have enough RAM for Bluetooth support."
echo ""
echo "Bluetooth Gamepad Support (Pico 2 W only):"
